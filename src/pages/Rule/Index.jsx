...
export default function Rule() {
  return (
    <div className="max-w-screen-md mx-auto text-white">
      ...
      <p>
        {" "}
        Khi người chơi đăng ký sử dụng 789BET, điều này đồng nghĩa với việc
        người chơi đã đọc, hiểu và đồng ý các quy định, điều khoản, và quy tắc
        tại 789BET.{" "}
      </p>{" "}
      <p>
        {" "}
        ...
        <br /> - Vi phạm quy định: 789BET có quyền từ chối phục vụ, đóng băng
        tài khoản và xử lý tùy và mức độ vi phạm nghiêm trọng.
        <br /> - Tranh chấp: Người chơi nên theo dõi quá trình chơi và kiểm tra
        thông tin tài khoản trước khi kết thúc.
        <br /> - Nhiều tài khoản: 789BET có quyền đóng hoặc giữ lại một tài
        khoản duy nhất.
        <br /> - Quyết định cuối cùng: Trong bất kỳ trường hợp nào, quyết định
        của 789BET là quyết định cuối cùng.{" "}
      </p>{" "}
      <Typography.Title
        level={2}
        className="!text-[var(--color-brand-primary)]"
      ...
      <p>
        ...
        nhận giao dịch.
        <br /> - Quyết định cuối cùng: 789BET không chịu trách nhiệm nếu giao
      ...
      <p>
        ...
        cầu xác thực.
        <br /> - Sử dụng khuyến mãi không trung thực: 789BET có quyền hủy và thu
        hồi khuyến mãi mà không cần báo trước.
        <br /> - Thay đổi chương trình: 789BET có quyền chỉnh sửa hoặc chấm dứt
      ...
      <p>
        {" "}
        Người chơi khi tham gia 789BET đã đồng ý với toàn bộ điều khoản, quy tắc
        và dịch vụ. 789BET có quyền thay đổi điều khoản nhằm phù hợp với hoạt
