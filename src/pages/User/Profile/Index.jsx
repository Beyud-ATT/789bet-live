...
const ProfileForm = () => {
  ...
  return (
    <>
      <Typography.Title
        level={2}
        className="!text-orange-500 lg:text-left text-center lg:!mb-4 uppercase font-bold"
      >
        Thay đổi hồ sơ cá nhân
      </Typography.Title>
      <div className="md:w-[80%] w-full h-full md:bg-[#0C111D] lg:py-8 px-4 lg:mx-0 mx-auto">
        <DeviceProvider.MOBILE>
          <Divider className={`md:w-2/3 w-full mx-auto !border-white`} />
        </DeviceProvider.MOBILE>
        <Form
          form={form}
          id="profile-form"
        ...
        >
          ...
          <Form.Item
            name="newCover"
            label={<span className="text-white">Ảnh cover</span>}
          >
            <Flex gap={10}>
              {accountData?.cover && (
                <Image
          ...
          <Form.Item
            name="username"
            label={<span className="text-white">Tên tài khoản</span>}
            disabled
          >
            <Input
          ...
          <Form.Item
            name="displayName"
            label={<span className="text-white">Tên hiển thị</span>}
          >
            <Input
