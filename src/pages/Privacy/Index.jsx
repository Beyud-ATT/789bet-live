...
export default function Privacy() {
  return (
    <div className="max-w-screen-md mx-auto text-white space-y-4">
      ...
      >
        Chính Sách Bảo Mật Thông Tin - 789BET
      </Typography.Title>
      <p>
        {" "}
        789BET cam kết bảo vệ quyền riêng tư của khách hàng với các tiêu chuẩn
        an toàn dữ liệu cao nhất. Dưới đây là chính sách bảo mật của chúng tôi,
      ...
      <Typography.Title
        ...
        className="!text-[var(--color-brand-primary)]"
      >
        1. Bảo Mật Thông Tin Cá Nhân tại 789BET
      </Typography.Title>{" "}
      <p>
        {" "}
        Tại 789BET, chúng tôi luôn giữ bảo mật tuyệt đối dữ liệu cá nhân của
      ...
      <p>
        {" "}
        - Khi khách hàng không thể truy cập vào trang web của 789BET có thể gửi
        tin nhắn trực tiếp đến email chính thức admin@789BET.com hệ thống sẽ
        phản hồi tự động gửi đường link truy cập mới nhất.{" "}
      </p>{" "}
      <p>
      ...
      <Typography.Title
        ...
        className="!text-[var(--color-brand-primary)]"
      >
        789BET - Nơi Khách Hàng Đặt Niềm Tin
      </Typography.Title>{" "}
      <p>
        {" "}
        Với chính sách bảo mật minh bạch, hệ thống công nghệ tiên tiến và cam
        kết bảo vệ quyền lợi khách hàng, 789BET mang đến sự an tâm tuyệt đối.
        Hãy đồng hành cùng chúng tôi để trải nghiệm dịch vụ an toàn và chuyên
        nghiệp.{" "}
      </p>
    </div>
  );
