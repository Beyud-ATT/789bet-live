      ...
      >
        ...
        <Form.Item>
          <Button
            type="primary"
            htmlType="submit"
            className="w-full h-12 bg-[var(--color-brand-primary-lighter)] hover:!bg-[var(--color-brand-primary)] border-none rounded-lg text-lg font-medium"
          >
            Đăng ký
          </Button>
        </Form.Item>
        ...
        <div className="text-center text-gray-300">
          ...
          <span
            href="#"
            className="text-[var(--color-brand-primary)] hover:text-[var(--color-brand-primary-lighter)] cursor-pointer"
            onClick={() => {
